		...
		<body style="background-color: LightGray">
			...
			<center>
				...
				CompanyId: <input type="number" name="companyId"
					placeholder="CompanyId" required autofocus /><br /> <br />
				PurchaseQuantity: <input type="number" name="purchaseQuantity"
					placeholder="PurchaseQuantity" required autofocus /><br /> <br />
