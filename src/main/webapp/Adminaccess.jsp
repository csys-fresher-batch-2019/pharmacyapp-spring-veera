...
<body style="background-color: white">
	...
	<center>
		...
		<a href="ProductDetails.jsp"><button type="submit"
				class="btn btn-primary btn-lg btn-block">Product Details</button></a></br> </br> <a
			href="SalesDetails.jsp"><button type="submit"
				class="btn btn-primary btn-lg btn-block">Sales Details</button></a></br> </br> <a
			href="StockMenu.jsp"><button type="submit"
				class="btn btn-primary btn-lg btn-block">Stock Details</button></a></br> </br> <a
			href="welcome.jsp"><button type="submit" class="btn btn-primary">LogOut</button></a></br>
		</br>
