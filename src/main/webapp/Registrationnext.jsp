		...
		<div id="formContent">
			...
			<form action="userRegistration" method="post">
				<input type="text" id="name" class="fadeIn second" name="name"
					placeholder="Name"> <input type="text" id="email"
					class="fadeIn third" name="emailId" placeholder="Email"> <input
					type="text" id="password" class="fadeIn third" name="password"
					placeholder="Password"> <input type="text" id="contact"
					class="fadeIn third" name="contact" placeholder="Contact">
